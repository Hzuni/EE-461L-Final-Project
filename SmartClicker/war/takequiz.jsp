...
<html>
  ...
  <body>
		<div id="page-wrap">
		<%
		pageContext.setAttribute("quiz_title", quiz.getProperty("title"));
		%>
			<div>
			  	<h1>${fn:escapeXml(quiz_title)}</h1>
			</div>
			...
			<div class="w3-card-4" style="width:100%; padding-bottom: 0px;">
				...
				<%
				pageContext.setAttribute("quiz_title", quiz.getProperty("title"));
				pageContext.setAttribute("quiz_content", quiz.getProperty("content"));
				pageContext.setAttribute("quiz_answer1", quiz.getProperty("answer1"));
				pageContext.setAttribute("quiz_answer2", quiz.getProperty("answer2"));
				pageContext.setAttribute("quiz_answer3", quiz.getProperty("answer3"));
				pageContext.setAttribute("quiz_answer4", quiz.getProperty("answer4"));
				%>
